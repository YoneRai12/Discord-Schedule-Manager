...
test("DMの自然な日本語をGPTなしで出欠へ分類する", () => {
  ...
  assert.deepEqual(parseDirectMessageRsvp("ABC1234 欠席します"), { meetingId: "ABC1234", status: "declined" });
  assert.deepEqual(parseDirectMessageRsvp("ABCD1234 欠席します"), { meetingId: "ABCD1234", status: "declined" });
  assert.deepEqual(parseDirectMessageRsvp("meeting id:MEET0001 参加します"), { meetingId: "MEET0001", status: "attending" });
